...
# TODO cascaded policy generation is a bit of a mess
class CascadedPolicy(Policy):
    def __init__(self, cascaded_policies: Union[Dict, List[Union[str, Policy, List, Dict]]]):
        ...
        if not isinstance(cascaded_policies, dict):
            ...
            policies = PolicyFactory.get_policy_from_dict(cascaded_policies, default_cascade=self.__class__).cascaded_policies
...
class PolicyFactory:
    ...
    @staticmethod
    def get_policy_from_dict(arg: Dict, default_cascade: CascadedPolicy.__class__ = AndPolicy) -> CascadedPolicy:
        policy_lookup = {
        ...
        return default_cascade(policies)
